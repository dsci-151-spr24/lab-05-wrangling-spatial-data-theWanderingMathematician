...
```
- *The minimum distance between a Denny's and a La Quinta in Alaska is `r min(dn_lq_ak_mindist$closest)`, while the average distance from a Denny's location to the closest La Quinta is `r mean(dn_lq_ak_mindist$closest)`. The middle value is much closer to the higher value than to the lower one.*
